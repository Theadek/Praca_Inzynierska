...
// camera
Camera camera(glm::vec3(0.0f, 0.5f, 12.0f));
...
int main()
{
    ...
    object->position = glm::vec3(5.0f, 1.0f, 1.0f);
    object->size = glm::vec3(1.0f, 1.0f, 1.0f);
    object->rotate = 0.0f;
    Object* object2 = new Object();
    object2->position = glm::vec3(1.0f, 1.0f, 1.0f);
    object2->size = glm::vec3(1.0f, 1.0f, 1.0f);
    object2->rotate = 0.0f;
    objModel->loadobj("Models/cube/cube.obj");
    // render loop
    // -----------
    while (!glfwWindowShouldClose(window))
    {
        ...
        //objModel->position.x += 0.01f;
        objModel->renderModel(&ourShader, object);

        objModel->renderModel(&ourShader, object2);
